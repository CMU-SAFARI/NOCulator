 ...
 * define.v
 *
 * @author Kevin Woo <kwoo@cmu.ed>
 *
 * These are the parameters for the brouter. You can adjust all the paremeters
 *  used.
 */
...
`define control_n   128      // Number of bits in the control field: INCLUDE DATA
