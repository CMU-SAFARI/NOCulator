        ...
        public static Controller construct()
        {
            switch (Config.controller)
            {
                ...
                case ControllerType.THREE_LEVEL:
                    return new Controller_Three_Level_Cluster_NoTrig();//new algo that does have a trigger point
				case ControllerType.NEIGHBOR_LOCAL:
					return new Controller_Neighbor_Local();
                default:
                    return new Controller();
            }
        }
