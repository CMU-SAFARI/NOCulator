...
{
    public class HR_16drop_Network : Network
    {
        public HR_16drop_Network(int dimX, int dimY) : base(dimX, dimY)
        {
            X = dimX;
            Y = dimY;
        }
      	public override void setup()
       	{
			if (Config.N != 16)
				throw new Exception("HR_16drop only suport 4x4 network");
