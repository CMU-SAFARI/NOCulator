...
{
    public class HR_16_8drop_Network : Network
    {
        public HR_16_8drop_Network(int dimX, int dimY) : base(dimX, dimY)
        {
            X = dimX;
            Y = dimY;
        }
      	public override void setup()
       	{
            ...
            nodeRouters = new Router_Node[Config.N];
           	L1bridgeRouters = new Router_Bridge[128];
			L2bridgeRouters = new Router_Bridge[32];
			L3bridgeRouters = new Router_Bridge[8];
