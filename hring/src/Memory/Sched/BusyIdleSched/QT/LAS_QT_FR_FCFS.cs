...
{
    class LAS_QT_FR_FCFS : LAS
    {

        public LAS_QT_FR_FCFS(int total_size, Bank[] bank)
            : base(total_size, bank)
        {
            Console.WriteLine("LAS_QT_FR_FCFS");
        }
        ...
        public override void tick()
        {
            ...
            for (int b = 0; b < bank_max; b++) {
                ...
                for (int j = 0; j < buf_load[b]; j++) {
                    ...
                    //int p = req.threadID;
                    ulong wait_time = MemCtlr.cycle - req.timeOfArrival;
                    ...
                    if(wait_time > (ulong)Config.memory.max_wait_thresh){
                        req.isMarked = true;
                    }
                }
            }
