...
namespace ICSimulator
{
    public class MemoryConfig : ConfigGroup
    {
        ...
        public int row_closed_latency = 300;   //closed row, access time in processor cycles
        public int row_hit_latency = 200;      //opened row, row hit, access time in processor cycles
        public int row_conflict_latency = 400; //opened row, row conflict, access time in processor cycles
