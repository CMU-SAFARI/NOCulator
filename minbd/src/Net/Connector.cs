...
{
    public abstract class Connector_Direct : Router
    {
        ...
        public Connector_Direct(Coord myCoord)
            : base(myCoord)
        {
    ...
    public class Connector_Direct_Random : Connector_Direct
    {
    ...
    public class Connector_Direct_OldestFirst : Connector_Direct
    {
        public Connector_Direct_OldestFirst(Coord myCoord)
            : base(myCoord)
        {
        }
    ...
    public class Connector_Direct_ClosestFirst : Connector_Direct
    {
    ...
    public class Connector_Direct_GP : Connector_Direct
    {
